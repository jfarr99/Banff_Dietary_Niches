...
ggplot(hill2[hill2$metric == "q1",], aes(x = value, fill = Species)) + geom_histogram() + facet_wrap(Species~Season)

hist(hill2[hill2$Species == "Bison" & hill2$metric == "q1" & Sea,]$value)
hist(hill2[hill2$Species == "Elk" & hill2$metric == "q1",]$value)
hist(hill2[hill2$Species == "BighornSheep" & hill2$metric == "q1",]$value)
...
Looking at species accumulation (rarefaction curves) to get population-level diet richness 
```{r}
